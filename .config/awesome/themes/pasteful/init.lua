...
local flavor = require("themes.pasteful.flavors." .. string.lower(ui_vars.flavor))
local theme = {}

-- base background colors
theme.bg_color = flavor.bg_color
theme.bg_2 = flavor.bg_2
theme.bg_3 = flavor.bg_3

-- foreground colors
theme.fg_color = flavor.foreground

-- base red colors
theme.red_color = flavor.red
theme.red_2 = flavor.red_2
theme.red_3 = flavor.red_3

-- base green color
theme.green_color = flavor.green
theme.green_2 = flavor.green_2
theme.green_3 = flavor.green_3

-- black color
theme.black_color = "#000000"

-- extra
theme.ext_white_bg = flavor.ext_white_bg

-- light theme colors
theme.ext_light_bg = flavor.ext_light_bg or nil
theme.ext_light_bg_2 = flavor.ext_light_bg_2 or nil
theme.ext_light_fg = flavor.ext_light_fg or nil
theme.ext_light_bg_3 = flavor.ext_light_bg_3 or nil

-- accent color
theme.accent = flavor.accent
theme.accent_2 = flavor.accent_2
theme.accent_3 = flavor.accent_3
...
-- images
theme.images = require("themes.pasteful.images")
...
-- wallpaper
-- ~~~~~~~~~
theme.wallpaper = theme.images.wallpaper
